...
export const getProperties = async (req: Request, res: Response): Promise<void> => {
  const { district, subdistrict, type, keyword, limit } = req.query;
  ...
  try {
    ...
    if (subdistrict && subdistrict !== "all") {
      whereClause.subdistrict = String(subdistrict);
    }
    if (type && type !== "all") {
    ...
    if (keyword) {
      ...
      whereClause.OR = [
        ...
        { subdistrict: { contains: kw, mode: "insensitive" } },
        { ledCaseNo: { contains: kw, mode: "insensitive" } },
        { deedNo: { contains: kw, mode: "insensitive" } }
      ];
    }
  ...
  try {
    ...
    const created = await prisma.property.create({
      data: {
        ...
        woodConditionPercent:
          body.woodDetails?.woodConditionPercent || body.woodConditionPercent || null,
